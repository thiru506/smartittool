...
$issuecategory = $_POST['issuecategory']; //Var containing your input data

$others = $_POST['others'];



/*$sql = mysql_query('INSERT INTO ost_form_entry_values (value) VALUES ("'. $issuecategory .'")')or die(mysql_error());
...
$sql = "INSERT INTO ost_dept_issuesCategories (issue_category, others) VALUES('$issuecategory', '$others')";
