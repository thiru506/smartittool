...
<body>
    <div id="container">
		...
		/*if ($cfg->getClientRegistrationMode() != 'disabled') { ?>
                    <a href="<?php echo $signin_url; ?>"><?php echo __('User Sign In'); ?></a>
<?php
                } */
...
<?php
                ...
                echo "<b>"."Date : " . date("d/m/Y"). "," . date("l"). "<br/>" ;
                
                date_default_timezone_set("Asia/Kolkata");
                echo "Time : " . date("h:i:sa"). "<br></b>";
                //echo "Today is: " . date("l")."</b>";
            } ?>
            </p>
            <p>
<?php
...
<?php }
            ...
            title="<?php echo __('SFPL Support Center'); ?>">
