...
<form action="tickets.php" method="get" id="ticketSearchForm">
    ...
    <input type="text" name="keywords" size="20" value="<?php echo Format::htmlchars($settings['keywords']); ?>">
    <input type="submit" value="<?php echo __('Search Request');?>">
<div class="pull-right">
    <?php echo __('Support Group'); ?>:
    <select name="topic_id" class="nowarn" onchange="javascript: this.form.submit(); ">
        <option value="">&mdash; <?php echo __('All Support Groups');?> &mdash;</option>
<?php
...
<table id="ticketTable" width="800" border="0" cellspacing="0" cellpadding="0">
    ...
    <thead>
        <tr>
            <th nowrap>
                <a href="tickets.php?sort=ID&order=<?php echo $negorder; ?><?php echo $qstr; ?>" title="Sort By Ticket ID"><?php echo __('Request #');?></a>
            </th>
            <th width="120">
            ...
            <th width="320">
                <a href="tickets.php?sort=subj&order=<?php echo $negorder; ?><?php echo $qstr; ?>" title="Sort By Subject"><?php echo __('Support Group');?></a>
            </th>
            <th width="120">
...
$sql_select = mysql_query('SELECT * FROM ost_dept_issuesCategories');
