...
//Get the goodies
include_once (PEAR_DIR.'Mail.php'); // PEAR Mail package
include_once (PEAR_DIR.'Mail/mime.php'); // PEAR Mail_Mime packge
...
$your_email = 'admin.sfpl@shgroup.in';//<<--  update this to your email address
...
?>
<form method="POST" name="email_form_with_php" action="email.php" enctype="multipart/form-data"> 
<p>
